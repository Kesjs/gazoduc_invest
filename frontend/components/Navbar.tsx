...
import { FiLogIn, FiUserPlus, FiUser, FiLogOut, FiX, FiMenu } from 'react-icons/fi';
...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm">
      ...
      <div 
        className={`sm:hidden transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-96' : 'max-h-0'}`}
        id="mobile-menu"
      >
